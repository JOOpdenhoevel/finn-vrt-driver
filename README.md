# A proof-of-concept driver for AMD Alveo V80 accelerators generated by the FINN and FINN+ frameworks
...
This is a port of the [high-performance finn-cpp-driver](https://github.com/eki-project/finn-cpp-driver) to VRT, the runtime library for AMD Alveo V80 accelerators provided by the [Slash project](https://github.com/Xilinx/Slash.git). It only acts as a proof-of-concept and is thus missing the polishing one might expect from a high-performance driver.
